...
CREATE TABLE clients (
    ...
    notes TEXT DEFAULT NULL,
    reels_required INT UNSIGNED NOT NULL DEFAULT 0,
    reels_completed INT UNSIGNED NOT NULL DEFAULT 0,
    posts_required INT UNSIGNED NOT NULL DEFAULT 0,
    posts_completed INT UNSIGNED NOT NULL DEFAULT 0,
