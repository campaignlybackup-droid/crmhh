            ...
            if (!empty($selected_ids)) {
                ...
                if (!empty($selected_ids)) {
                    if ($bulk_action === 'delete') {
                        ...
                        $stmt->execute($params);
                        $_SESSION['flash_success'] = count($selected_ids) . " leads deleted.";
                        ...
                        if ($new_status) {
                            ...
                            $stmt->execute($params);
                            $_SESSION['flash_success'] = count($selected_ids) . " leads updated.";
                        }
                        ...
                        $stmt->execute($params);
                        $_SESSION['flash_success'] = count($selected_ids) . " leads reassigned.";
                    }
                }
            }
...
<?php else: ?>
    <!-- TABLE VIEW -->
    <form id="bulkForm" method="POST" action="leads.php">
                ...
                <table class="table table-hover mb-0 align-middle">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                <td class="ps-3"><input type="checkbox" class="form-check-input row-checkbox" name="selected_ids[]" value="<?= $lead['id'] ?>"></td>
